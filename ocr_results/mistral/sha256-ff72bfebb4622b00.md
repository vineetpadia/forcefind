# Model-1330-Aluminum-Single-Point-Load-Cell__ff72bfebb4

- PDF: `datasheets/vpg/Model-1330-Aluminum-Single-Point-Load-Cell__ff72bfebb4.pdf`
- SHA-256: `ff72bfebb4622b00937a54f68080f8b855371d3a090e3198feabcfd6ae55ea1a`
...
The Model 1330 is a high capacity single-point load cell, designed for direct mounting of low profile high capacity weighing platforms up to 800 x 800 mm.

The large platform size simplifies the construction of floor scales, baggage scales, hanging scales and other types of weighing machines.

A special humidity resistant protective coating assures long-term reliability. The two additional sense wires feed back the voltage reaching the load cell. Complete compensation of changes in lead resistance, due to temperature change and/or cable extension, is achieved by feeding this voltage into the appropriate electronics.
...
|  Rated capacity—R.C. (E_{max}) | 500, 750, 1000 |   | kg  |
|  NTEP/OIML accuracy class | Non-Approved | C3* |   |
|  Maximum no. of intervals (n) | 1000 | 3000 |   |
|  Y = E_{max}/V_{min} | 2000 | 15000 | Maximum available  |
...
|  Temperature effect on zero | 0.0100 | 0.0023 | ±% of rated output/°C  |
|  Temperature effect on output | 0.0030 | 0.0010 | ±% of applied load/°C  |
|  Eccentric loading error | 0.0037 | 0.0025 | ±% of rated load/cm  |
