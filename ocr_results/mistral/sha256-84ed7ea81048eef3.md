...
- PDF: `datasheets/laumas/tll.pdf`
- SHA-256: `84ed7ea81048eef3cebeab668a06432b5d07bed4e28beb7d0c952096f24f69e8`
...
- Current or voltage 16 bit optoisolated analog output (TLLANA).
- 4 relay outputs controlled by the setpoint values or via protocols (2 outputs if synchronous serial transmission is present).
- 2 optoisolated PNP digital inputs: status reading via serial communication protocols (1 input if synchronous serial transmission is present).
- 1 load cell dedicated input.

MAIN FUNCTIONS

- Connections to:
  - PLC via synchronous serial communication;
  - PLC via analog output (TLLANA);
...
|  Relay outputs | 4/2 - max 115 VAC/150mA  |
|  Optoisolated digital inputs | 2/1 - 5÷24 VDC PNP  |
|  Serial ports | synchronous transmission, RS485, RS232  |
