# pc5h_can_datasheet_en_b0302080f9__d455200435

- PDF: `datasheets/flintec/pc5h_can_datasheet_en_b0302080f9__d455200435.pdf`
- SHA-256: `d455200435a4d4333c12d16bf8acc85b097496d2cbe93f01b451dafcdf3c6022`
- OCR model: `mistral-ocr-latest`

## Page 1

# PC5H CAN single point load cell



## product description

The PC5H CAN is designed for rear-end bin lifting systems on waste collection vehicles. Its high capacity of 2,000kg allows for highly accurate and rugged weighing performance, replacing alternative aluminium load cell-based systems. Fully hermetically sealed and constructed from stainless steel, the PC5H CAN is built to withstand harsh environments.

An embedded CAN board transforms the PC5H into a fully digital load cell, eliminating the need for external signal converters while maintaining high accuracy and durability in demanding applications.
...
single point load cells | PC5H CAN | www.flintec.com

pc5h-can-sp-dat-en-v0
